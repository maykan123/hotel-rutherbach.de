...
function LocationSection() {
  return (
    <section id="lage" className="py-16 sm:py-20 bg-primary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
          ...
          >
            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-white mb-4 sm:mb-6">
              Perfekte Lage in <span className="text-accent">Essen-Kettwig</span>
            </h2>
            ...
            <div className="space-y-3 sm:space-y-4 mb-6 sm:mb-8">
              <div className="flex items-start space-x-3 sm:space-x-4 p-3 sm:p-4 bg-primary-light rounded-lg">
          ...
          >
            {/* Google Maps Embed */}
            <div className="relative h-[250px] sm:h-[350px] lg:h-[400px] rounded-xl sm:rounded-2xl overflow-hidden border border-gray-700">
              <iframe
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4">
              <div className="p-2 sm:p-4 bg-primary-light rounded-lg text-center border border-gray-700">
            ...
            {/* Address Box */}
            <div className="p-4 sm:p-6 bg-primary-light rounded-xl border border-gray-700">
